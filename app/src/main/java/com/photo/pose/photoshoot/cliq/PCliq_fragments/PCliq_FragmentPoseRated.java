...
public class PCliq_FragmentPoseRated extends Fragment {
    ...
    private void getWallpaperData() {
        if (methods.isNetworkAvailable()) {
            ...
            Call<PCliq_ItemPoseList> call = PCliq_APIClient.getClient().create(PCliq_APIInterface.class).getWallpapersByRated(methods.getAPIRequest(PCliq_Constant.URL_WALLPAPER_BY_RATED, 0, color_ids, wallType, "", "", "", "", "", "", "", "", new PCliq_SharedPref(getActivity()).getUserId(), ""));
