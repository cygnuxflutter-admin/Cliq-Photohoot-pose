...
public class PCliq_CircularRevealAnimationFactory implements PCliq_IAnimationFactory {
    ...
    public PCliq_CircularRevealAnimationFactory() {
    ...
    @Override
    public void animateTargetToPoint(PCliq_MaterialShowcaseView showcaseView, Point point) {
