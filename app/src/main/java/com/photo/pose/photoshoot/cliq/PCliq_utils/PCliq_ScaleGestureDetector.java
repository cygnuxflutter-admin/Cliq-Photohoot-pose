 ...
 * </ul>
 */
public class PCliq_ScaleGestureDetector {
     ...
     * <ul>
     *  <li>One {@link OnScaleGestureListener#onScaleBegin(PCliq_ScaleGestureDetector)}
     *  <li>Zero or more {@link OnScaleGestureListener#onScale(PCliq_ScaleGestureDetector)}
     *  <li>One {@link OnScaleGestureListener#onScaleEnd(PCliq_ScaleGestureDetector)}
     * </ul>
     */
    public interface OnScaleGestureListener {
         ...
         *          greater than 0.01.
         */
        public boolean onScale(View view, PCliq_ScaleGestureDetector detector);
         ...
         *          rest of the gesture.
         */
        public boolean onScaleBegin(View view, PCliq_ScaleGestureDetector detector);

        /**
         * Responds to the end of a scale gesture. Reported by existing
         * pointers going up.
         *
         * Once a scale has ended, {@link PCliq_ScaleGestureDetector#getFocusX()}
         * and {@link PCliq_ScaleGestureDetector#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        public void onScaleEnd(View view, PCliq_ScaleGestureDetector detector);
    }
     ...
     * {@link OnScaleGestureListener#onScale(PCliq_ScaleGestureDetector)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link OnScaleGestureListener#onScaleBegin(PCliq_ScaleGestureDetector)} returns
     * {@code true}.
     */
    ...
    private PCliq_Vector2D mCurrSpanVector;
    ...
    public PCliq_ScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new PCliq_Vector2D();
    }
    ...
    public PCliq_Vector2D getCurrentSpanVector() {
