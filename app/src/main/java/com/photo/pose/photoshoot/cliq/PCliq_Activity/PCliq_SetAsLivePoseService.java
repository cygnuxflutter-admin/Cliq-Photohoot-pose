...
public class PCliq_SetAsLivePoseService extends WallpaperService {
    ...
    private class GIFWallpaperEngine extends Engine {
        ...
        public void onSurfaceCreated(SurfaceHolder surfaceHolder) {
            ...
            try {
                bufferedInputStream2 = new BufferedInputStream(getContentResolver().openInputStream(PCliq_Constant.uri_set), 16384);
    ...
    public static void setAsWallPaper(Context context) {
        PCliq_Methods.setAsLiveWallPaper(context, context.getPackageName() + ".SetAsLiveWallpaperService");
    }
