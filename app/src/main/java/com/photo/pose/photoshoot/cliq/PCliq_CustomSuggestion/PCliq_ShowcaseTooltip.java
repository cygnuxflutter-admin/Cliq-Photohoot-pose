...
public class PCliq_ShowcaseTooltip {
    ...
    private PCliq_ShowcaseTooltip(Context context){
        MyContext myContext = new MyContext(getActivityContext(context));
        this.tooltip_view = new TooltipView(myContext.getContext());
    }

    public static PCliq_ShowcaseTooltip build(Context context) {
        return new PCliq_ShowcaseTooltip(context);
    }
    ...
    public PCliq_ShowcaseTooltip position(Position position) {
        this.tooltip_view.setPosition(position);
        return this;
    }

    public PCliq_ShowcaseTooltip customView(View customView) {
        this.tooltip_view.setCustomView(customView);
        return this;
    }

    public PCliq_ShowcaseTooltip customView(int viewId) {
        this.tooltip_view.setCustomView(((Activity) view.getContext()).findViewById(viewId));
        return this;
    }

    public PCliq_ShowcaseTooltip arrowWidth(int arrowWidth) {
        this.tooltip_view.setArrowWidth(arrowWidth);
        return this;
    }

    public PCliq_ShowcaseTooltip arrowHeight(int arrowHeight) {
        this.tooltip_view.setArrowHeight(arrowHeight);
        return this;
    }

    public PCliq_ShowcaseTooltip arrowSourceMargin(int arrowSourceMargin) {
        this.tooltip_view.setArrowSourceMargin(arrowSourceMargin);
        return this;
    }

    public PCliq_ShowcaseTooltip arrowTargetMargin(int arrowTargetMargin) {
        this.tooltip_view.setArrowTargetMargin(arrowTargetMargin);
        return this;
    }

    public PCliq_ShowcaseTooltip align(ALIGN align) {
    ...
    public PCliq_ShowcaseTooltip color(int color) {
        this.tooltip_view.setColor(color);
        return this;
    }

    public PCliq_ShowcaseTooltip color(Paint paint) {
        this.tooltip_view.setPaint(paint);
        return this;
    }

    public PCliq_ShowcaseTooltip onDisplay(ListenerDisplay listener) {
        this.tooltip_view.setListenerDisplay(listener);
        return this;
    }

    public PCliq_ShowcaseTooltip padding(int left, int top, int right, int bottom) {
    ...
    public PCliq_ShowcaseTooltip animation(TooltipAnimation tooltipAnimation) {
        this.tooltip_view.setTooltipAnimation(tooltipAnimation);
        return this;
    }

    public PCliq_ShowcaseTooltip text(String text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public PCliq_ShowcaseTooltip text(int text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public PCliq_ShowcaseTooltip corner(int corner) {
        this.tooltip_view.setCorner(corner);
        return this;
    }

    public PCliq_ShowcaseTooltip textColor(int textColor) {
        this.tooltip_view.setTextColor(textColor);
        return this;
    }

    public PCliq_ShowcaseTooltip textTypeFace(Typeface typeface) {
        this.tooltip_view.setTextTypeFace(typeface);
        return this;
    }

    public PCliq_ShowcaseTooltip textSize(int unit, float textSize) {
        this.tooltip_view.setTextSize(unit, textSize);
        return this;
    }

    public PCliq_ShowcaseTooltip setTextGravity(int textGravity) {
        this.tooltip_view.setTextGravity(textGravity);
        return this;
    }

    public PCliq_ShowcaseTooltip distanceWithView(int distance) {
        this.tooltip_view.setDistanceWithView(distance);
        return this;
    }

    public PCliq_ShowcaseTooltip border(int color, float width) {
