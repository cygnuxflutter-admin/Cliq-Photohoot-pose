...
public class PCliq_AspectRatioFragment extends DialogFragment {
    ...
    public static PCliq_AspectRatioFragment newInstance(Set<AspectRatio> ratios,
                                                        AspectRatio currentRatio) {
        final PCliq_AspectRatioFragment fragment = new PCliq_AspectRatioFragment();
