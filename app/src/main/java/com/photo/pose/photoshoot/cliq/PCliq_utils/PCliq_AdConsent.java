...
public class PCliq_AdConsent {

    private ConsentForm form;
    private Context context;
    private PCliq_AdConsentListener adConsentListener;

    public PCliq_AdConsent(Context context, PCliq_AdConsentListener adConsentListener) {
    ...
    public void checkForConsent() {
        ...
        String[] publisherIds = {PCliq_Constant.publisherAdID};
